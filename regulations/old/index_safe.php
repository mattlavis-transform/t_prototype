                    ...
                    <table class="govuk-table govuk-table--m sticky">
                        ...
                        <thead class="govuk-table__head">
                            <tr class="govuk-table__row">
                                ...
                                <th scope="col" class="govuk-table__header tip" aria-describedby="tip_legal_base">
                                    Legal base
                                    <span id="tip_legal_base" class="tooltip govuk-visually-hidden" role="tooltip" aria-hidden="true">
                                        Stuff about legal bases
                                    </span>
                                </th>
                                <th scope="col" class="govuk-table__header tip" aria-describedby="tip_regulation_group">
                                    Regulation group
                                    <span id="tip_regulation_group" class="tooltip govuk-visually-hidden" role="tooltip" aria-hidden="true">
                                        It's vital that the regulation group is assigned correctly to a regulation If not, the
                                        measures belonging to a regulation may not behave as expected in the border systems. See more information
                                        on <a class='govuk-link' href="/regulation_groups">regulation groups</a>.
                                    </span>
                                </th>
