...
$geographical_area2 = new geographical_area;
$geographical_area2->geographical_area_sid = get_querystring("sid");
$geographical_area2->populate_from_db();

if ($geographical_area->geographical_code == "1") {
    $inset_message = "This action will terminate <b>$geographical_area2->description ($geographical_area2->geographical_area_id)</b>'s membership of the group <b>$geographical_area->description ($geographical_area->geographical_area_id)</b>.";
} else {
    $inset_message = "This action will terminate <b>$geographical_area->description ($geographical_area->geographical_area_id)</b>'s membership of the group <b>$geographical_area2->description ($geographical_area2->geographical_area_id)</b>.";
}
        ...
        <main class="govuk-main-wrapper" id="main-content" role="main">
            <div class="govuk-grid-row">
                <div class="govuk-grid-column-three-quarters">
                    <!-- Start main title //-->
                    <h1 class="govuk-heading-xl">Terminate membership</h1>
                    <!-- End main title //-->
                </div>
            </div>
            ...
            <div class="govuk-grid-row">
                <div class="govuk-grid-column-three-quarters">
                    <form action="termination_confirmation.html">
                        <?php
                        new inset_control(
                            $text = $inset_message
                        );
                        new date_picker_control(
                            ...
                            $hint_text = "Please enter the date on which you would like this membership to terminate. The termination will take effect at midnight at the end of the day selected.",
                            $control_name = "validity_start_date",
                            $default = "",
                            $required = ""
                        );
                        new button_control("Terminate membership", "terminate", "primary", true, "");
                        new button_control("Cancel", "cancel", "text", false, "javascript:history.back();");
                        ?>
