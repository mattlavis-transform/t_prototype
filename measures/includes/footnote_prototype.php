<div class="govuk-grid-row">
    <div class="govuk-grid-column-full">
        ...
        new table_control($measure_prototype->footnote_list, "footnote_table", "<p class='govuk-body' style='margin-top:2em;margin-bottom:2em'>There are currently no footnotes assigned to the current measure(s).</p>");
        ?>
        <form>
            <?php
            new input_control(
                ...
                $control_name = "measure_prototype_footnote_id",
